...
`APM-Start`: The starter files set up for use in VSCode, WebStorm, or other editors. 
...
If you want to work through the course without downloading npm or any of the libraries, try the course with Stackblitz by following this link: https://stackblitz.com/edit/github-qgzp1d?file=README.md
